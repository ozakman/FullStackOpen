...
The watchman file is too big to load tro the github. Github refuses
to load too ,any files with the comment:
...
So, had to delete almost all the watchman files.
